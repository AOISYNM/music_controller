    ...
    return (
        <>
            <style>{`
                ...
                .neon-input-wrap { width: 100%; position: relative; }
                .neon-input {
                    width: 100%;
                ...
                .neon-input::placeholder { color: rgba(255,255,255,0.2); letter-spacing: 0.04em; }
                .neon-input:focus {
                    border-color: rgba(139,92,246,0.6);
                    background: rgba(139,92,246,0.06);
                    box-shadow: 0 0 0 3px rgba(139,92,246,0.15), 0 0 20px rgba(139,92,246,0.2);
                }
                .neon-input.has-error {
                    border-color: rgba(236,72,153,0.6);
                    box-shadow: 0 0 0 3px rgba(236,72,153,0.12), 0 0 20px rgba(236,72,153,0.15);
                }
                .error-text { font-size: 0.78rem; color: #f472b6; margin-top: 0.5rem; text-align:center; }
            ...
            <div className="home-root">
                ...
                <div className="card">
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                        <p className="subheading">Enter your code</p>
                    ...
                    <div className="neon-input-wrap">
                        <input
                            className={`neon-input${error ? " has-error" : ""}`}
                    ...
                    <div className="btn-row">
                        <button className="btn-primary" onClick={roomJoinButtonPressed}>
                            Enter Room
                        </button>
